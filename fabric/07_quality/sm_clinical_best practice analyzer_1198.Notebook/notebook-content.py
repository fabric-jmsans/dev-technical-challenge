...
dataset = "sm_clinical" # Enter the name or ID of the semantic model
workspace = "DEV Technical Challenge" # Enter the workspace name or ID in which the semantic model exists
